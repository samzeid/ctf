...
namespace Interactive360
{
    ...
    //I don't think this script is being used in-game anywhere
    public class MenuManager : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("m_oculusMenuToggle")] [SerializeField] string m_buttonMenuToggle = "Button2"; //The name of the button input that will toggle the scene on and off
        ...
        //OpenXR: Confirm m_buttonMenuToggle (Button2) binding is setup correctly
        //If we detect input, call the toggleMenu method 
        private void checkForInput()
        {
            //check for input from specified button
            if (Input.GetButtonDown(m_buttonMenuToggle))
            {
                toggleMenu();
